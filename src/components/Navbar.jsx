...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className={`bg-white py-3 md:text-sm ${state ? "shadow-me" : ""}`}>
        <div className="gap-x-16 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
          ...
          >
            ...
            <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
              ...
              <a
                href="javascript:void(0)"
                className="flex items-center justify-center gap-x-1 py-3 px-4 text-white font-medium bg-blue-600 hover:bg-blue-700 active:bg-blue-900 rounded-md md:inline-flex"
              >
                Get started &rarr;
                {/* <svg
                  xmlns="http://www.w3.org/2000/svg"
